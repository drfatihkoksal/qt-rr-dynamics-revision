...
**Response:** We agree that the submitted Methods were not sufficiently reviewable. The revised main Methods now provides an intuitive description of the two aims, units, network, direct-QT uncertainty, QT–RR reference, matching, and inferential hierarchy. Supplementary Sections S1–S3 give the exact input, layer channels, kernels, loss equations and coefficients, landmark-presence rule, optimizer, scheduler, batch size, stopping rule, seed, split logic, hysteresis equation, matching rule, statistical estimands, cluster definition, bootstrap/permutation procedure, and multiplicity family. The model has 5,982,928 trainable parameters. We make no claim that the revision received external mathematical expert review; the expanded reproducibility material is provided to enable it.

**Changes in the manuscript:** Methods Sections 2.1–2.5, numbered manuscript pages 3–5, lines 58–125; Supplementary Sections S1–S3; Supplementary Figure S5; Data and Code Availability.
...
**Changes in the manuscript:** The manuscript was revised throughout; title, Highlights and Abstract are on numbered pages 1–2, lines 1–44; the reorganized main text is on pages 2–9, lines 45–246.
...
**Response:** We agree with the concern and corrected the interpretation. The revised Results separately shows that database-labeled ischemic episodes differed from matched baseline by 7.67 ms (95% CI, 5.06 to 10.95) in equal-subject mean absolute residual. The direct ischemic-versus-heart-rate-related estimate was 4.87 ms (95% CI, −0.73 to 10.46; p=0.087), which means only that this study did not demonstrate a larger ischemic departure. It does not show that ischemia has no repolarization effect and does not establish equivalence. The limited paired analysis of nine both-label subjects was −1.36 ms (95% CI, −9.27 to 5.64), underscoring imprecision.
...
**Changes in the manuscript:** Results Sections 3.3–3.5, numbered pages 6–7, lines 147–187; Discussion and Limitations, pages 7–9, lines 188–239; Figure 1 and legend, pages 10–11, beginning at line 288; Methods Section 2.5, page 4, lines 110–125.
...
**Changes in the manuscript:** Methods Sections 2.4–2.5, numbered page 4, lines 98–125; Results Section 3.4, pages 6–7, lines 159–179; Discussion, pages 7–8, lines 188–227; Supplementary Sections S2 and S5; Figures S1, S2, and S4.
...
The heart-rate-related-versus-baseline equal-subject effect was 6.20 ms (95% CI, 3.00 to 9.68) in nine subjects with any raw ischemic annotation and 3.66 ms (95% CI, 0.78 to 6.67) in 16 subjects without one. The interaction was 2.54 ms (95% CI, −2.50 to 7.57; p=0.305). Therefore overlap alone did not account for the association, but the interaction was too imprecise to exclude meaningful modification. The nine-subject within-subject direct comparison is presented as a limited sensitivity analysis.

**Changes in the manuscript:** Results Sections 3.2–3.4, numbered pages 5–7, lines 139–179; Discussion, pages 7–8, lines 188–227; Table 1, page 12, beginning at line 302; Table 4; Supplementary Section S4 and editable overlap tables.
...
**Response:** We no longer use “non-ischemic patients”; we use “subjects without an annotated ischemic episode.” We extracted historical clinical-header metadata with three prespecified categories: documented coronary disease, explicitly documented absence, and unknown/insufficient. Among the 25 heart-rate-related contributors, these categories contained 8, 8, and 9 subjects. Their exploratory heart-rate-related-versus-baseline estimates were 8.74 ms (95% CI, 5.46 to 12.07), 0.38 ms (95% CI, −1.83 to 3.03), and 4.61 ms (95% CI, 1.00 to 8.38), respectively. Because headers are historical and incomplete, these results cannot establish clinical substrate or episode mechanism.
...
**Changes in the manuscript:** Results Sections 3.4–3.5, numbered pages 6–7, lines 159–187; Discussion and Limitations, pages 7–9, lines 188–239; Supplementary Sections S4 and S7; Tables 1 and 4.
...
**Changes in the manuscript:** Discussion and Limitations, numbered pages 7–9, lines 188–239; Conclusion, page 9, lines 240–246; Supplementary Figures S1–S5.
...
Page and continuous-line references above correspond to `manuscript_revised_numbered.pdf`, generated from the same clean source as the DOCX. The clean and marked DOCX files also contain continuous line-numbering instructions; journal-system conversion may repaginate them.
