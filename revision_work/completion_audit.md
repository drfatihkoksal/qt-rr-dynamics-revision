...
| Per-subject subgroups and interaction | Complete | `subgroup_effects.csv`, Figure 2C, Table 4 |
| Exploratory clinical substrate | Complete with stated metadata limitation | `subject_clinical_metadata.csv`, `subgroup_effects.csv`, Results 3.4 |
| Beat/episode/equal-subject/within-subject hierarchy | Complete | `hierarchical_effects.csv`, `subject_level_results.csv`, Table 3 |
...
| Dynamic-rate adjustment | Complete | `subgroup_effects.csv`, Table 4; attenuation reported in Abstract/Results/Discussion |
...
| Clean/marked manuscript and other DOCX files | Complete | `paper/docx_revision/`; marked text highlighted; DOCX integrity QA |
